...
<head>
  <meta charset="utf-8">
  <title>ASSEMBLE | Admin Pages</title>
...
<div class="row" style="margin-left:15px;">
  <p class="uname_box" style="height:31px; width:220px; margin-bottom: 12px;">
    ADMIN
                    ...
                    <div class="flex-fill">
        <a href="myTeams.php">
          <li><i class="fas fa-users" style="font-size:24px;"> Reviewed reports</i></li>
        </a>
</div>
                    <div class="flex-fill">
        <a href="createTeam.php">
          <li><i class="fas fa-plus" style="font-size:24px;"> Rejected reports</i></li>
        </a>
      </div>
                          <div class="flex-fill">
        ...
        <a href="editProfile.php">
          <li><i class="fas fa-user-cog" style="font-size:24px;"> Profile Setting</i></li>
        </a>
      </div></div>
      </ul>
    </div>
