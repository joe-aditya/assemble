      ...
      <div class="col-sm-12">
        <div class=" cardd container">
          ...
          <div class="txtscroll" style="height:393px;">
            ...
            <div class="col-sm-6">
                <div class="container-fluid" id="enrolledcourses">
                  <div class="container">

                    <div class="row">
                      <p>CHANGE PIC</p>
                      <input type="file" id="avatar" name="avatar" accept="image/png, image/jpeg" style="color: white;">
            ...
            <div class="col-sm-6">
                <div class="container-fluid p-0" id="enrolledcourses">
                  <div class="container">
                    ...
                    <div class="row">
                      <div class="txtb">Change Password:
                        <input type="password" id="pwdc" name="pwdc" placeholder="Current Password" />
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="txtb">
                        <input type="password" id="pwdc" name="pwdc" placeholder="Confirm New-Password" />
                      </div>
                    </div>
                  </div>
                </div>
